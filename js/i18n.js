...
window.I18N = {
  ar: {
    ...
    "common.min":"دقيقة","common.cal":"سعرة","common.loading":"جارٍ التحميل...","common.cancel":"إلغاء",
    ...
    "auth.forgot":"نسيت كلمة المرور؟","auth.forgotSent":"إن كان البريد مسجّلاً ستصلك رسالة الاستعادة 📧",
    "auth.resetTitle":"تعيين كلمة مرور جديدة","auth.newPass":"كلمة المرور الجديدة","auth.resetCta":"تحديث كلمة المرور","auth.resetDone":"تم تحديث كلمة المرور ✅","auth.err.invalid_token":"رابط غير صالح أو منتهٍ",
    "p.export":"تصدير بياناتي","p.delete":"حذف الحساب",
    "del.title":"حذف الحساب","del.body":"سيُحذف حسابك وكل بياناتك نهائياً ولا يمكن التراجع.","del.confirm":"نعم، احذف نهائياً","del.done":"تم حذف حسابك","export.done":"تم تنزيل بياناتك 📦",
    "sub.cancel":"إلغاء الاشتراك","sub.cancelBody":"ستبقى مزايا Pro فعّالة حتى نهاية الفترة المدفوعة.","sub.cancelConfirm":"نعم، ألغِ التجديد","sub.cancelled":"تم إلغاء التجديد ✅","sub.cancelErr":"تعذّر إلغاء الاشتراك",
  ...
  en: {
    ...
    "common.min":"min","common.cal":"cal","common.loading":"Loading...","common.cancel":"Cancel",
    ...
    "auth.forgot":"Forgot password?","auth.forgotSent":"If the email is registered, a reset link is on its way 📧",
    "auth.resetTitle":"Set a new password","auth.newPass":"New password","auth.resetCta":"Update password","auth.resetDone":"Password updated ✅","auth.err.invalid_token":"Invalid or expired link",
    "p.export":"Export my data","p.delete":"Delete account",
    "del.title":"Delete account","del.body":"Your account and all your data will be permanently deleted. This cannot be undone.","del.confirm":"Yes, delete permanently","del.done":"Your account was deleted","export.done":"Your data was downloaded 📦",
    "sub.cancel":"Cancel subscription","sub.cancelBody":"Your Pro features stay active until the end of the paid period.","sub.cancelConfirm":"Yes, cancel renewal","sub.cancelled":"Renewal cancelled ✅","sub.cancelErr":"Couldn't cancel the subscription",
